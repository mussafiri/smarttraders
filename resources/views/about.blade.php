                    ...
                    <div class="col-md-6 col-sm-12 col-xs-12">
                        <div class="about-content">
                            ...
                            <p>We are a private trading and investment company licensed to trade for proprietary account on regulated exchanges (DMCC), 
                               ...
                               FUTURES AND COMODITIES as well as diversify its own capital in Real estates as one of asset management of the company..<strong><a href="javascript:showMore()" id="link" onclick="showMore()">read more</a></strong> 
                                <br><br>
                           </p>
