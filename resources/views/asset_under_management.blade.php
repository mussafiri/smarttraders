...
<style>
    ...
    .owl-theme .owl-nav [class*='owl-carousel'] {
        transition: all .3s ease;
    }

    .owl-theme .owl-nav [class*='owl-carousel'].disabled:hover {
    ...
    .asset-box:before {
        ...
        border-image-source: linear-gradient(to right, #0A3041, #23A6E0, rgba(0, 0, 0, 0));
    }
  .asset-box-right:before{
        position: absolute;
        content: '';
        right: 3px;
        top: 1px;
        ...
        border-style: solid;
        border-image-slice: 1;
        border-image-source: linear-gradient(to left, #0A3041, #23A6E0, rgba(0, 0, 0, 0)); 
  }
    .prices-asset {
        font-size: 40px;
        font-weight: 700;
...
<div class="background-color">
    <div class="background-color-1">
        <div class="invest-area  page-padding-2">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-12 col-xs-12">
                        <div class="asset-box">
                            <div class="section-headline text-left my-auto">
                                <div class="top-price-inner" style="margin-bottom: 10px;">
                                    <div class="rates">
                                        <span class="prices-asset">Oxford Bulverde </span>
                                    </div>
                                </div>
                                <p>
                                    Oxford Boulevard by Iman Developer, a
                                    forthcoming development that offers
                                    impressively designed homes located at
                                    Jumeirah Village Circle, Dubai.
                                    This elegantly designed structure building
                                    offers top-notch facilities and amenities with
                                    round-the-clock security and a lavish
                                    collection of retail outlets at its ease.
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-sm-12 col-xs-12">
                        <div class="shape-outer heptagon">
                            <div class="shape-inner heptagon">
                                <div class="images-slider-vertical">
                                    <div class="item">
                                        <img src="{{asset('img/about/as1.jpg')}}" alt="">
                                    </div><!-- item -->
                        ...
                        <div class="col-md-12">
                            <div id="myCarousel" class="carousel slide" data-ride="carousel" align="center">
                                <div class="carousel-inner">
                                    <div class="carousel-item active"> <img src="{{asset('img/about/realestate4.jpg')}}" class="rounded"> </div>
                                    <div class="carousel-item"> <img src="{{asset('img/about/realestate5.jpg')}}" class="rounded"> </div>
                                    <div class="carousel-item"> <img src="{{asset('img/about/realestate6.jpg')}}" class="rounded"> </div>
                                </div>
                                <ol class="carousel-indicators list-inline">
                                    <li class="list-inline-item active"> <a id="carousel-selector-0" class="selected" data-slide-to="0" data-target="#myCarousel"> <img src="{{asset('img/about/realestate4.jpg')}}" class="img-fluid rounded"> </a> </li>
                                    <li class="list-inline-item"> <a id="carousel-selector-1" data-slide-to="1" data-target="#myCarousel"> <img src="{{asset('img/about/realestate5.jpg')}}" class="img-fluid rounded"> </a> </li>
                                    <li class="list-inline-item"> <a id="carousel-selector-2" data-slide-to="2" data-target="#myCarousel"> <img src="{{asset('img/about/realestate6.jpg')}}" class="img-fluid rounded"> </a> </li>
                                </ol>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-6 col-sm-12 col-xs-12">
                        <div class="shape-outer heptagon">
                            <div class="shape-inner heptagon">
                                <div class="images-slider-vertical">
                                    <div class="item">
                                        <img src="{{asset('img/about/as2.jpg')}}" alt="">
                                    </div><!-- item -->
                                </div><!-- images-slider-horizontal -->
                            </div>
                        </div>
                    ...
                    <div class="col-md-6 col-sm-12 col-xs-12">
                        <div class="asset-box-right">
                            <div class="section-headline text-left my-auto">
                                <div class="top-price-inner" style="margin-bottom: 10px;">
                                    <div class="rates">
                                        <span class="prices-asset">Stela Marris </span>
                                    </div>
                                </div>
                                <p>
                                A one-of-a-kind residential tower that
                                redefines the marina district and offers 52
                                floors of unparalleled luxurious living. Stella
                                Maris sits comfortably within the heart of
                                Dubai
                                </p>
                            </div>
                        </div>
                ...
                <div class="container">
                    <div class="row d-flex justify-content-center mt-5">
                        <div class="col-md-12">
                            <div id="myCarousel" class="carousel slide" data-ride="carousel" align="center">
                                <div class="carousel-inner">
                                    <div class="carousel-item active"> <img src="{{asset('img/about/realestate1.jpg')}}" class="rounded"> </div>
                                    <div class="carousel-item"> <img src="{{asset('img/about/realestate2.jpg')}}" class="rounded"> </div>
                                    <div class="carousel-item"> <img src="{{asset('img/about/realestate3.jpg')}}" class="rounded"> </div>
                                </div>
                                <ol class="carousel-indicators list-inline">
                                    <li class="list-inline-item active"> <a id="carousel-selector-0" class="selected" data-slide-to="0" data-target="#myCarousel"> <img src="{{asset('img/about/realestate1.jpg')}}" class="img-fluid rounded"> </a> </li>
                                    <li class="list-inline-item"> <a id="carousel-selector-1" data-slide-to="1" data-target="#myCarousel"> <img src="{{asset('img/about/realestate2.jpg')}}" class="img-fluid rounded"> </a> </li>
                                    <li class="list-inline-item"> <a id="carousel-selector-2" data-slide-to="2" data-target="#myCarousel"> <img src="{{asset('img/about/realestate3.jpg')}}" class="img-fluid rounded"> </a> </li>
                                </ol>
                            </div>
                        </div>
                    </div>
