...
<section class="home-slider js-fullheight owl-carousel">
  <div class="slider-item js-fullheight" style="background-image:url('images/xbg_1.jpg.pagespeed.ic.f5OX-Qmui2.jpg')">
    ...
    <div class="container">
      <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-end" data-scrollax-parent="true">
        <div class="col-md-7 text ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
          ...
          <p><a href="index.html#" class="btn btn-white btn-outline-white px-4 py-3 mt-3" data-toggle="modal" data-target="#modalRequest">Make an Appointment</a></p>
        </div>
      </div>
    </div>
  </div>
  <div class="slider-item js-fullheight" style="background-image:url('images/xbg_2.jpg.pagespeed.ic.JnpvkPTHqk.jpg')">
    <div class="overlay"></div>
    <div class="container">
      <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-end" data-scrollax-parent="true">
        <div class="col-md-7 text ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
...
<section class="ftco-section ftc-no-pb">
  <div class="container">
    <div class="row no-gutters">
      <div class="col-md-5 p-md-5 img img-2 d-flex justify-content-center align-items-center" style="background-image:url('images/xabout.jpg.pagespeed.ic.v3RcvtQaCB.jpg')">
      ...
      <div class="col-md-7 wrap-about pb-md-5 ftco-animate">
        ...
        <div class="pl-md-5 ml-md-5">
          <div class="info-contact mb-5">
            ...
            <p><span>E-Mail:</span> <span><a href="index.html#"><span class="__cf_email__" data-cfemail="771e19111837121a1e161b5914181a">[email&#160;protected]</span></a></span></p>
          </div>
          <div class="info-contact mb-5">
            <h3>Address Information</h3>
            <p><span>Address</span> <span> 203 Fake St. Mountain View, San Francisco, California, USA</span></p>
            <p><span>Fax:</span> <span>(00) 123 - 456 - 789</span></p>
            <p><span>E-Mail:</span> <span><a href="index.html#"><span class="__cf_email__" data-cfemail="640d0a020b2401090d05084a070b09">[email&#160;protected]</span></a></span></p>
          </div>
        </div>
      </div>
    </div>
