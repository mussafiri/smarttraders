...
@include('shared.footer')
  ...
  <script type="application/javascript" src="{{ asset('phonemask_js/phonemask.js')}}"></script>
...
<script>
	var autoPlayVideo = document.getElementById("autoplay");
...
<script>
	$(window).load(function() {
		...
		$('#videoLoad').fadeOut(milliseconds | 300, "fast");
	});
</script>
</body>
