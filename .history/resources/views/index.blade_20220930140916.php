  ...
  <div class="container">
    <div class="row no-gutters">
      <div class="col-md-5 p-md-5 img img-2 d-flex justify-content-center align-items-center" style="background-image:url('images/ximage_3.jpg.pagespeed.ic.fX3scSkV2D.jpg')">
        <a href="{{asset('videos/smart_traders_overview.mp4')}}" class="icon popup-vimeo d-flex justify-content-center align-items-center">
          <span class="icon-play" style="font-size:32px;"></span>
        </a>
      </div>
