...
<input type="text" class="form-control rounded" placeholder="Your Full Name">
</div>
<!-- <div class="form-group row col-12"> -->
  <div class="form-group">
    <input type="text" class="form-control rounded" placeholder="Your Email">
  </div>
  <div class="form-group">
    <input class="form-control rounded" style="width:232%;" id="phone" type="tel" placeholder="0528080570">
  </div>
<!-- </div> -->
<div class="form-group">
...
<div class="form-group">
<textarea name="" id="" cols="30" rows="7" class="form-control rounded" placeholder="Your Message To Us"></textarea>
</div>
<div class="form-group">
