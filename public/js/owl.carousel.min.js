!(function(a, b, c, d) {
            ...
            run: function() {
                ...
                if (
                    (this.$stage.css(e),
                        ...
                        (e[this.settings.rtl ? "margin-left" : "margin-right"] = this.settings.margin), !this.settings.autoWidth &&
    ...
    (e.prototype.addTriggerableEvents = function() {
        ...
        a.each({ next: this.next, prev: this.prev, to: this.to, destroy: this.destroy, refresh: this.refresh, replace: this.replace, add: this.add, remove: this.remove },
